  ...
  return (
    <section className='w-full my-6' id='menu'>
        <div className="w-full flex flex-col items-center justify-center">
            ...
            What Tasty Are You Going To Eat Today?
            </p>
            ...
            <div className='w-full flex items-center justify-start lg:justify-center gap-8 py-6 overflow-x-scroll scrollbar-none'>
                {foods && foods.map((category) => (
                    ...
                    } w-24 min-w-[94px] h-24 cursor-pointer rounded-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center hover:bg-cartNumBg`} onClick={() => setFilter(category.urlParamName)}>
