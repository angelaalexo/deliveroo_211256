  ...
  return (
    <motion.div initial={{ opacity: 0, x: 200 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 200 }} className='fixed top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]'>
      ...
      <div className="w-full flex items-center justify-between p-4 cursor-pointer">
            ...
            <motion.p whileTap={{ scale: 0.75 }} onClick={clearCart} className="flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 rounded-md hover:shadow-md  cursor-pointer text-textColor text-base" >
            Clear <RiRefreshFill />
            </motion.p>
      </div>
      ...
      <div className="w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2">
        ...
        <div className="w-full h-full flex flex-col items-center justify-center gap-6">
          ...
          <p className="text-sm text-orange-600 font-semibold ml-6">
            Looks like you have not added anything to your cart. Go ahead & explore tasty our tasty foods!
          </p>
        </div>
      )}
    </motion.div>
